...
function changeImage(a)
{
  ...
  if(open_ele.length == 1)
  {
       ...
       if(open_ele[0].style.backgroundImage.split("/")[2] == open_ele[1].style.backgroundImage.split("/")[2])
       {
          ...
          document.getElementsByClassName("score")[0].getElementsByTagName("li")[len-1].innerHTML="Bloques desbloqueados : " + String(total) + " / 8"; 

          if(total == 8) //if all matches are found
          {
            showModal();
        ...
        else
        {
          ...
          if(attempts == 0)
          {
            ...
            fail=1;
            eles = document.getElementsByClassName("score")[0].getElementsByTagName("li");
            eles[eles.length-2].innerHTML="Jugador 1 : " + mode +" <span style='color : rgb(252,3,11);'>Perdiste</span>";
            document.getElementsByTagName("table")[0].style.display="none";
            document.getElementsByClassName("message")[0].style.display="block";
            document.getElementsByClassName("message")[0].innerHTML=":( Oops.....Vaya, te quedaste sin intentos.";
            document.getElementsByClassName("message-button")[0].style.display="block";
            open_ele.length=0;
             return;
          }
...
function setDifficulty(_mode)
{
  ...
  li_1.innerHTML="Jugador 1 : "+ mode +" <span style='color : rgb(227,72,20);'> en curso</span>";
  li_2.innerHTML="Bloques desbloqueados : " + String(total) + " / 8"; 
